...
const { fauxAssistantMessage, getApiProvider, registerFauxProvider } = piAi;
...
export function fixturePath(path) {
    ...
    if (rel.startsWith("..") || isAbsolute(rel))
        throw new Error("fixture path must stay inside cwd");
    return absolute;
}
 ...
 */
export function resolveActiveStep(context) {
...
export default function fauxProviderExtension(pi) {
    ...
    const router = (context, options, state, model) => {
...
//# sourceMappingURL=faux-provider.ext.js.map