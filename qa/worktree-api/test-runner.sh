...
echo "[test-runner] Running worktree API tests..."
node qa/worktree-api/worktree-api.test.mjs
echo "[test-runner] API tests passed!"

echo "[test-runner] Running browser tests..."
node qa/worktree-api/worktree-browser.test.mjs
