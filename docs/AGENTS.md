...
| `vendored-relay-refresh.md` | Refresh policy for vendored playwright-core CDL relay: verify upstream in memory, copy, patch specifiers, rehash. Never hand-edit vendor. See change: fix-browser-plugin-vendor-specifier-resolution. |
