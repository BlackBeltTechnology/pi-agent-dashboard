...
| `architecture.md` | Full architecture reference. 3 components: bridge extension, Node server, React client. KB retrieval pipeline (FTS5 BM25 staged rerank). → see `architecture.md.AGENTS.md` |
