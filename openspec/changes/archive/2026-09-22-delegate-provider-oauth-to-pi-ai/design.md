...
flowchart TD
  ...
  B --> C["preAnswers = typeof enterpriseDomain === 'string'<br/>? [enterpriseDomain] : []  — null / non-string → no pre-answer"]
  ...
  E -->|first auth_url / device_code / answerable prompt| F["200 OAuthFlowStatus<br/>progress / info are NOT first events"]
