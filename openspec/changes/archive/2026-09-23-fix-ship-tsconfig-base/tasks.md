...
- Full import-correctness for the root meta-package (~250 pre-existing findings). Open as a new OpenSpec change.
- After merge, cut 0.8.1 via the `release-cut` skill.
