...
- [x] 4.4 Install `npm:pi-hermes-memory` and verify Pi resolves it.
...
- [x] 6.2 Verify `@blackbelt-technology/pi-dashboard-subagents@0.2.4`, `pi-blackhole`, and `pi-hermes-memory` remain in `pi list`, and pi-vcc is absent.
