...
| `sidebar-dnd.ts` | Shared drag-and-drop helpers for sidebar `SessionList`. Exports `compatibleClosestCenter` + `DRAG_TARGETS` (type-aware collision…, `resolveFolderMove` → see `sidebar-dnd.ts.AGENTS.md` |
