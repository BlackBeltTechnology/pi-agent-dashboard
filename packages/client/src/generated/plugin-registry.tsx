...
import { FolderCouncilSection, FolderCouncilBoard, CouncilBoard, CouncilBadgeClaim, hasCouncilStatus, CouncilSettings } from "../../../pi-openspec-council/src/client/index";
...
export const PLUGIN_REGISTRY: RegistryEntry[] = [
  ...
  },
  {
    manifest: {
        "id": "council",
        "displayName": "Super OpenSpec",
        "priority": 100,
        "claims": [
            {
                "slot": "sidebar-folder-section",
                "component": "FolderCouncilSection"
            },
            {
                "slot": "shell-overlay-route",
                "component": "FolderCouncilBoard",
                "path": "/folder/:encodedCwd/council",
                "depth": 1
            },
            {
                "slot": "shell-overlay-route",
                ...
                "path": "/council/:id",
                "depth": 2,
                "parentPath": "/folder/:encodedCwd/council"
            },
            {
                "slot": "session-card-badge",
                "component": "CouncilBadgeClaim",
                "shouldRender": "hasCouncilStatus"
            },
            {
                "slot": "settings-section",
                "component": "CouncilSettings",
                "tab": "general"
            }
        ],
        "client": "./src/client/index.tsx",
    ...
    claims: [
      { pluginId: "council", priority: 100, slot: "sidebar-folder-section", Component: FolderCouncilSection },
      { pluginId: "council", priority: 100, slot: "shell-overlay-route", path: "/folder/:encodedCwd/council", depth: 1, Component: FolderCouncilBoard },
      { pluginId: "council", priority: 100, slot: "shell-overlay-route", path: "/council/:id", depth: 2, parentPath: "/folder/:encodedCwd/council", Component: CouncilBoard },
      { pluginId: "council", priority: 100, slot: "session-card-badge", Component: CouncilBadgeClaim, shouldRender: hasCouncilStatus },
      { pluginId: "council", priority: 100, slot: "settings-section", tab: "general", Component: CouncilSettings },
    ],
  },
  {
    manifest: {
...
export const PLUGIN_REGISTRY_HASH = "c200f4b04cb3b0689e4c74bf300be9223f819e84ab47e5a67a74eebe7678cc02";
