...
export const catalog = {
  hu: {
    ...
    recBadge: "ajánlott",
    recHaiku: "gyors, olcsó, megőrzi a stílust – ~2–4 mp",
    recSonnet: "alapos, lassabb – ~8 mp",
    recOpus: "legalaposabb, drágább – ~7 mp",
    recGemini: "jó nem-Anthropic választás",
    recAvoid: "Kerüld a gyenge/lite modelleket (pl. gemini-flash-lite-latest) – nem javítják a hibákat.",
