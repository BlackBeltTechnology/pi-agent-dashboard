...
export const USAGE_LIMIT_PATTERN =
  /usage[_ ]limit[_ ]reached|usage_not_included|insufficient_quota|credit[_ ]balance|quota[_ ]exceeded|resource[_ ]exhausted|monthly[_ ]limit|monthly[_ ]spending[_ ]cap|hourly[_ ]limit|daily[_ ]limit|spending[_ ]cap|out of (?:credits?|budget)|(?:no|0) (?:weighted )?tokens? (?:left|remaining)|not[^\"]{0,20}enough credits?|billing|exceeded[^"]{0,40}(quota|cap|spending)|reset after \d+[hms]/i;
