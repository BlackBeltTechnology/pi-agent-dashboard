...
// Updated for c52745af0 (static landing page): site/ has NO dependencies —
// no npm ci, no cache-dependency-path, no astro build (`npm run build` is a
// copy + reference check). The old dual-install contract (site/ stays npm)
